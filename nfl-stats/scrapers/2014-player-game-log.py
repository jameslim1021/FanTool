            ...
            if url_obj[team][week]["date"] == "Bye Week":
                ...
                for i in range(0,len(player_data_array)-1):
                    player_log[team][week][names[i]] = {
                        ...
                        "passYards": player_data_array[i][3],
                        "passTds": player_data_array[i][4],
                        "interceptions": player_data_array[i][5],
                        "numSacks": player_data_array[i][6],
                        "sackYards": player_data_array[i][7],
                        "passLong": player_data_array[i][8],
                        "qbr": player_data_array[i][9] if len(player_data_array[i][9]) > 0 else '0',
                        "carries": player_data_array[i][10],
                        "rushYards": player_data_array[i][11],
                        "rushTds": player_data_array[i][12],
                        "rushLong": player_data_array[i][13],
                        "targets": player_data_array[i][14],
                        "receptions": player_data_array[i][15],
                        "recYards": player_data_array[i][16],
                        "recTds": player_data_array[i][17],
                        "recLong": player_data_array[i][18],
                        "fumbles": player_data_array[i][19],
                        "fumblesLost": player_data_array[i][20],
                    }
